...
def evaluate(ast, environment):
    ...
    if ast["tag"] in ["in", "not in"]:
        ...
        if ast["tag"] == "in":
            ...
            return left_value not in right_value, None
...
def test_membership():
    print("test evaluate membership")
...
def test_evaluate_assignment_statement(): #edit for added assignment operators?

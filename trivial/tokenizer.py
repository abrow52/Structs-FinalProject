...
#added tests
def test_membership_tokens():
    print("testing added tokens...")

    assert clean(tokenize("x in y")) == [
        {"tag": "identifier", "value": "x"},
        {"tag": "in"},
    ...
    assert clean(tokenize("x not in y")) == [
        {"tag": "identifier", "value": "x"},
        {"tag": "not in"},
        {"tag": "identifier", "value": "y"},
        {"tag": None},
